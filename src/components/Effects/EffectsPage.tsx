import { allEffectsRoutes } from '@/lib/routes/EffectsRouetes';
...
import { Seo } from '../Seo';
import { Toc } from '../Toc';
import { EffectsPagination } from './EffectsPagination';

type Props = WithChildren & React.ComponentPropsWithoutRef<typeof Seo>;

export const EffectsPage = ({ children, title, description, image }: Props) => {
  return (
    <>
      ...
      <Grid container spacing={16}>
        <Grid component="main" item xs={12} lg={8}>
          <Stack spacing={16} sx={{ py: 8 }}>
            ...
            <EffectsPagination routes={allEffectsRoutes} />
          </Stack>
        </Grid>
        <Grid
          component="aside"
