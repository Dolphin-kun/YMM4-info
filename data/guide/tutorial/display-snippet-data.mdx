...
ここでは、[スニペットを登録する](/next-mdx-site/guide/tutorial/getting-started/)
...
`[...slug].tsx`を作成して
[動的なルーティング](https://nextjs-ja-translation-guide.vercel.app/guide/routing/dynamic-routes)
を行います。
...
実はこのコード、`src/pages/guide/[...slug].tsx`
の実装とほとんど変わりありません。
